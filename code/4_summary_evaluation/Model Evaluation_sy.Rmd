...
merge_df_ext <- cbind(prep_df_ext, external_behavior$library.predict)
merge_df_int <- cbind(prep_df_int, internal_behavior$library.predict)
...
# SL.library_name = c('Logistic', 'Lasso', 'RF_untuned', 'RF_tuned', 'Group Lasso')
